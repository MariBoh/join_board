...
export const FAKE_TASKS: FakeTask[] = [
    {
        fakeId: 'fake1',
        fakeTitle: 'Design new dashboard',
        fakeDescription: 'Create wireframes for the new admin dashboard',
        fakeCategory: 'Design',
        fakePriority: 'high',
        fakeStatus: 'todo',
        ...
        fakeSubtasks: [
            ...
            { fakeTitle: 'Get feedback from team', fakeCompleted: false }
        ]
    },
    {
        fakeId: 'fake2',
        fakeTitle: 'Fix login bug',
        fakeDescription: 'Users reporting 404 errors on login page',
        fakeCategory: 'Development',
        fakePriority: 'medium',
        fakeStatus: 'todo',
